...
const Contact = () => {
    ...
    return (
        <section id="contact" className="py-12 mb-5 md:py-24 md:pb-0">
            ...
            >
                <div>
                    <p className="mx-auto font-playfair font-semibold text-4xl">
            ...
            <div className="md:flex md:justify-between gap-16 mt-10 md:mt-5">
                ...
                >
                    <div className="contact-bg"><img src={ContactImg} alt="contact-img" /></div>
                </motion.div>
                ...
                >
                    <form
                        target="_blank"
                        onSubmit={onSubmit}
                        action="https://formsubmit.co/5a9c78a4b8c98f5d69e14f75bfd0e32a"
                        method="POST"
                    >
                        <input
