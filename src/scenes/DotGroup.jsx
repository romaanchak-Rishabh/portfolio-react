...
const DotGroup = ({ selectedPage, setSelectedPage }) => {
    ...
    return (
        <div className="flex flex-col gap-6 fixed top-[60%] right-7">
            ...
            />
            <AnchorLink className={`${selectedPage==="skillset" ? selectedStyles : "bg-dark-grey"}
                w-3 h-3 rounded-full`}
                href="#skillset"
                onClick={() => setSelectedPage("skillset")}
            />
            ...
            />
            <AnchorLink className={`${selectedPage==="yourstruly" ? selectedStyles : "bg-dark-grey"}
                w-3 h-3 rounded-full`}
                href="#yourstruly"
                onClick={() => setSelectedPage("yourstruly")}
            />
